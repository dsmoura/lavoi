...
@Entity
public class ArtifactDTO extends Artifactable implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@Id
	@SequenceGenerator(name = "artifact_generator", allocationSize=1)
	@GeneratedValue(strategy=GenerationType.AUTO, generator="artifact_generator")
	private Integer artifactPk;
	...
	public Integer getArtifactPk() {
		return artifactPk;
	}

	public void setArtifactPk(Integer artifactPk) {
		this.artifactPk = artifactPk;
	}
